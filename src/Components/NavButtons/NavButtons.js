    ...
    return ( 
        <div>
            <div className="page-next">
                <button className={clsx({ 'disabled': current === slide[slide.length - 1] })} onClick={handleClickNext}> 
                    <div>Next</div>
                </button>
            </div>
            <div className="page-prev">
                <button className={clsx({ 'disabled': current === slide[0] })} onClick={handleClickPrev}> 
                    <div>Prev</div>
                </button>
            </div>
